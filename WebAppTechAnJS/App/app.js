var techAnJSApp = angular.module('techAnJSApp', ['ngResource']);

techAnJSApp.controller('TechAnJSAppController', ['$scope', '$resource', function ($scope, $resource) {

    var JsonDataResource = $resource("api/JsonData");
    ...
    function drawAllPlots() {
        ...
        var svg = d3.select("#all-plots-div").append("svg")
        ...
        var r = JsonDataResource.query().$promise.then(function (data) {
